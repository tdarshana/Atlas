...
// core the process plugin sits on, launch at login, the global shortcut and the
// clipboard. The page only calls these; it never imports a plugin's own JS package.
