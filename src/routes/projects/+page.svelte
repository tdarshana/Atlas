<script lang="ts">
	...
	import { Button, Input, Table, type TableColumn } from '$lib/ds';
	...
	const columns: TableColumn<Project>[] = [
		...
		{ key: 'seen', label: 'Last seen', width: '110px', align: 'right' }
	];
...
{:else}
	...
	>
		{#snippet cell(project: Project, column: TableColumn<Project>)}
