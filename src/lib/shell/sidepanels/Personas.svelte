<script lang="ts">
	// Two groups over the same list the `/personas` table draws: a row per tag that
	// narrows the table, and a row per project with how many personas its roster holds.
	// Counts come from the store, so a persona saved on the route is counted here
